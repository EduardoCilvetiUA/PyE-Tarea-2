...
confianza90 = st.norm.interval (alpha = 0.90, loc = np.mean (bajo100), scale = st.sem (bajo100))
confianza95 = st.norm.interval (alpha = 0.95, loc = np.mean (bajo100), scale = st.sem (bajo100))
confianza100 = st.norm.interval (alpha = 0.100, loc = np.mean (bajo100), scale = st.sem (bajo100))
